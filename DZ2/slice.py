...
# 2017.03.08 01:46:43 checked. P.Rusanov
# Отлично!
def even(s):
...
# 2017.03.08 01:46:52 checked. P.Rusanov
# Отлично!
def reverse(s):
    return ' '.join(s.split()[-1::-1])     # ' '.join(s.split()[::-1])
...
# 2017.03.08 01:47:12 checked. P.Rusanov
# Отлично!
def shift(s):
    list_s = s.split()[0:-1]
...
# 2017.03.08 01:47:23 checked. P.Rusanov
# Отлично!
def palindrome(d):    
    sd = str(d)
...
# 2017.03.08 01:47:49 checked. P.Rusanov
# Отлично!
def inside(s):
    l = s.split()
    # А что нам говорит PEP8 про длину строк?
